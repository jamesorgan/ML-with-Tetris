	...
	if(statc[player * 10] < 15 + (anim * 2)) {
		for(i = 0; i < 22; i++) {
			if(erase[i + player * 22]) {
				ExBltRect(5, (boffset[player]) * 8, (i + 3) * 8, 0, (statc[player * 10] - anim2) * 8, 80, 8);
...
void statLaser(int player) {
	...
	// レーザー発射前
		...
		if(!statc[player * 10 + 2]) {
			...
			// 照準を表示
			for(i = 0; i <= lasernum[player]; i++) {
				ExBltRect(28, (boffset[player] + laserpos[i + player * 4] - 1) * 8, 24, 0, 0, 24, 24);
			}
		}
		// 16t用
		else {
			...
			// 照準を表示
			ExBltRect(3, (boffset[player] + laserpos[0 + player * 4] - 1) * 8, 18, 0, 203, 32, 23);
		}
	}
	// レーザー発射の瞬間
	else if(statc[player * 10] == 120) {
		...
		if(!statc[player * 10 + 2]) {
			...
			for(i = 0; i <= lasernum[player]; i++) {
				...
				ExBltRect(28, (boffset[player] + k) * 8, 40, 24, 0, 8, 160);
				ExBltRect(28, (boffset[player] + k - 1) * 8, 24, 0, 0, 24, 24);
		...
		if(!statc[player * 10 + 2]) {
			...
			for(i = 0; i <= lasernum[player]; i++) {
				if(statc[player * 10] - 120 < 34) {
					...
					ExBltRect(28, (boffset[player] + laserpos[i + player * 4]) * 8, 40, 24 + (j * 8), 0, 8, 160);
				}
				ExBltRect(28, (boffset[player] + laserpos[i + player * 4] - 1) * 8, 24, 0, 0, 24, 24);
			}
		} else {
			...
			if(j < 20) {
				ExBltRect(3, (boffset[player] + laserpos[0 + player * 4] - 1) * 8, ((j + 3) * 8) + 18, 0, 203, 32, 23);
			}
		}
	}
...
void statExchangeField(int player) {
	...
	if(statc[player * 10] == 0) {
		...
		if((statc[player * 10] >= 60 - player) && (statc[player * 10] < 70 - player)) {
			...
			ExBltFast(17, foffset[player] + 8 + (j * 8), 40);
		}
...
void statItemRulet(int player) {
	...
	ExBltRect(46, (boffset[player] + 1) * 8, 116, (8 * statc[player * 10 + 2]) + 56, 0, 8, 8);
	ExBltRect(79, (boffset[player] + 2) * 8, 112, 0, statc[player * 10 + 2] * 16, 48, 16);
	ExBltRect(46, (boffset[player] + 8) * 8, 116, (8 * statc[player * 10 + 2]) + 56, 0, 8, 8);
...
void bananaProc(int player) {
	...
	if(banana_c[player] == 0) {
		...
		if((y > 1) && (y <= 7))
			ExBltRect(53, foffset[player] + 8, 32, 0, 50 * (count % 4) + (50 - ((y - 1) * 8)), 80, (y - 1) * 8);
		else if((y > 21) && (y <= 27))
			ExBltRect(53, foffset[player] + 8, 26 + (y * 8) - 50, 0, 50 * (count % 4), 80, ((28 - y) * 8));
		else if((y > 7) && (y <= 21))
			ExBltRect(53, foffset[player] + 8, 24 + (y * 8) - 50, 0, 50 * (count % 4), 80, 50);
